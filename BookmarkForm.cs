...
namespace Practice_2__Local_Web_Bookmark
{
    public partial class BookmarkForm : Form
    {
        ...
        private void saveAsToolStripMenuItem_Click(object sender, EventArgs e)//TODO: if the file exists, overwrite it
        {
            ...
            if (saveFileDialog1.ShowDialog() == DialogResult.OK)
            {
                ...
                //    DialogResult dialogResult = MessageBox.Show("This file already exists. Do you want to replace it?", "File",
        ...
        {                       
            ...
            Uri www;
            Uri.TryCreate(listboxitem, UriKind.RelativeOrAbsolute, out www);
            if (WebValidator.URLIsValidhttp(listboxitem)) 
            {
        ...
        private void ellilpsisButton_Click(object sender, EventArgs e)
        {                      
            Form Info = new Info();
            Info.Show();    
        }
